...
function Home(){
    ...
    return(
        <div className=" container container-md container-sm container-lg h-100  container-Home">
                    ...
                    <div className="row">
                        <div className="col-12 content-home-prof">
                            <nav className="nav justify-content-center">
                                <a className=" bg-warning nav-link active" aria-current="page" href="#">New </a>
                                <a className=" text-white nav-link" href="#">Poste</a>
